...
### Ideation Process
1. Create low-fidelity initial wireframes
2. Conduct user testing
3. Make changes based on feedback from user testing
4. Conduct final user testing
5. Make changes based on feedback from user testing
6. Create final high-fidelity prototype

### Prototype Goals

We are looking to learn about the different pain points that our users are struggling with so we can iterate back on the prototype based on the feedback we receive during testing.
...
- Learn if users are able to understand the questions
